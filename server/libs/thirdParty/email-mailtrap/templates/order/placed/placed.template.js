...
export const setOrderPlacedEmailTemplate = ({
  firstName,
  today,
  year,
  courseTitle,
...
Hey ${firstName}, Congratulations! You've been enrolled to the ${courseTitle} Course!

You now have access to the associated class content which includes video instruction and an exam.

You may access the class by logging into your account now!

Here are your order details:


If you have any questions please reach out to support@bodydynamix.com
`;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="h2 pb15" style="color:#000; font-family:'Poppins', Arial,sans-serif; font-size:28px; line-height:34px; text-align:left; padding-bottom:15px;"><multiline>Ready to Learn?</multiline></td>
</tr>
<tr>
<td class="text" style="color:#777777; font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:30px; text-align:left;"><multiline>Hey ${firstName},<br/>
Congratulations! You've been enrolled to the <strong>${courseTitle}</strong> Course!<br/><br/>

You now have access to the associated class content which includes video instruction and an exam.<br/><br/>

You may access the class by logging into your account now!<br/><br/>

Here are your order details:<br/>
Course Title: <strong>${courseTitle}</strong><br/>
Course Instructor: <strong>${courseInstructor}</strong><br/>
Payment Method: <strong>${paymentMethod}</strong><br/>
Total Paid: <strong>${totalPaid}</strong><br/>

If you have any questions please reach out to <a href="mailto:support@bodydynamix.com">support@bodydynamix.com</a></multiline></td>
</tr>
</table>
</td>
</tr>
