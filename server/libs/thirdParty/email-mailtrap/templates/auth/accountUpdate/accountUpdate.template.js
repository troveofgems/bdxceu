...
export const setAccountInfoUpdatedEmailTemplate = (user) => {
  const subject = "Your BodyDynamix Account Has Been Updated";
  ...
  We noticed a password update was made to your account information and wanted to verify that with you for security 
  purposes. If you updated your account, please disregard this email. 
  
  ${
    user.adminUpdate
      ? "If you did not ask a Site Administrator to update your account, please reach out to the BodyDynamix support " +
        `staff immediately. The last update to your account was made on:${user.updatedAt}.`
      : "If you did not update your account, please reach out to the BodyDynamix support staff immediately." +
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="h2 pb15" style="color:#000; font-family:'Poppins', Arial,sans-serif; font-size:28px; line-height:34px; text-align:left; padding-bottom:15px;"><multiline>Your Password Has Been Successfully Updated!</multiline></td>
</tr>
<tr>
...
We noticed an update was made to your account information and wanted to verify for
security purposes. If you updated your account, please disregard this email.<br/><br/>
