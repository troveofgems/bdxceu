...
export const setRegistrationTeamMemberEmailTemplate = ({
  firstName,
  today,
  year,
  email,
...
Hey ${firstName}, Congratulations! You've been onboarded onto the BodyDynamix Team!

This is exciting for both you and us. We look forward to having you as part of our team.
A Team Member account has been created for you.

You can explore your BodyDynamix Account with the following credentials:

Username: ${email}
Password: ${password}

If you have any questions please reach out to your internal company resource.
`;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="h2 pb15" style="color:#000; font-family:'Poppins', Arial,sans-serif; font-size:28px; line-height:34px; text-align:left; padding-bottom:15px;"><multiline>Ready to Teach?</multiline></td>
</tr>
<tr>
...
Congratulations! You've been onboarded onto the BodyDynamix Team!<br/><br/>
This is exciting for both you and us. We look forward to having you as part of our team.
A Team Member account has been created for you.<br/><br/>

You can explore your BodyDynamix Account with the following credentials:<br/><br/>

Username: <strong>${email}</strong><br/>
Password: <strong>${password}</strong><br/><br/>

Please reset your password at your nearest convenience using the <strong>Forgot Password Link</strong> in the login page.<br/><br/>

If you have any questions please reach out to your internal company resource.</multiline></td>
</tr>
</table>
</td>
</tr>
