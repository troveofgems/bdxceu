...
export const setProductPublishedEmailTemplate = ({
  today,
  year,
  courseTitle,
  courseInstructor,
  ...
  const subject = `A Product Has Been Published!`;
...
Hey BDXCEU Team, A new course has been published to the website!

Users will now be able to sign up for: ${courseTitle}.

If you are the instructor and have any questions after reviewing the course material, please reach out to our internal support.
`;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="h2 pb15" style="color:#000; font-family:'Poppins', Arial,sans-serif; font-size:28px; line-height:34px; text-align:left; padding-bottom:15px;"><multiline>New Offering!</multiline></td>
</tr>
<tr>
<td class="text" style="color:#777777; font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:30px; text-align:left;"><multiline>Hey BDXCEU Team,<br/>
A Product Has Been Published!<br/><br/>

Users will now be able to sign up for BDXCEU's: <strong>${courseTitle}</strong>.<br/><br/>
...
Course Cost: <strong>${courseCost}</strong><br/>

If you are the instructor and have any questions after reviewing the course material, please reach out to our internal support.</multiline></td>
</tr>
</table>
</td>
</tr>
