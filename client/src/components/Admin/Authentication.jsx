...
import {TeamMemberForm} from "./TeamMember/TeamMember";
export const AuthenticationModal = ({ modalType }) => {
    Modal.setAppElement('#root');

    const applyButtonStyle = () => "wow fadeInUp smoothScroll btn btn-default";
    ...
    const applyFaceCTAButtonLabel = () => {
        if(modalType.includes("admin-registration")) {
            return "Add Administrator";
        } else if (modalType.includes("add-team-member")) {
        ...
        <div>
            ...
            >
                ...
                <div className="session">
                    ...
                    {showForm === "teamMember" && <TeamMemberForm />}
                </div>
            </Modal>
        </div>
    );
