...
const AdminOrderByIdScreen = () => {
  ...
  const {
    ...
    refetch,
    error: orderError,
  } = useFetchOrderByIdForAdminQuery(orderId);
            ...
            <Row>
              <Col lg={4}>
                <Row>
                  ...
                  <Col lg={5}>
                    <p className={"lead"}>
                      <strong>{order?.data?.productName}</strong>
                    </p>
                  </Col>
                  <Col lg={5}>
                  ...
                  <Col lg={5}>
                    <p className={"lead"}>
                      <strong>
                        {order?.data?.paymentResult?.status === "COMPLETED"
                          ? "PAID"
                          : "NOT PAID"}
                      </strong>
                    </p>
              ...
              <Col lg={4}>
                <Row>
                  ...
                  <Col lg={6}>
                    <p className={"lead"}>
                      <strong>{order?.data?.paymentMethod}</strong>
                    </p>
                  </Col>
                  <Col lg={5}>
                  ...
                  <Col lg={6}>
                    <p className={"lead"}>
                      <strong>{order?.data?.paymentResult?.payerId}</strong>
                    </p>
                  </Col>
                  <Col lg={5}>
                  ...
                  <Col lg={6}>
                    <p className={"lead"}>
                      <strong>{order?.data?.paymentResult?.orderId}</strong>
                    </p>
                  </Col>
                  <Col lg={5}>
                  ...
                  <Col lg={6}>
                    <p className={"lead"}>
                      <strong>
                        {formatDate(order?.data?.paymentResult?.updateTime)}
                      </strong>
                    </p>
                  </Col>
                </Row>
              ...
              <Col lg={4}>
                <Row>
                  ...
                  <Col lg={6}>
                    <p className={"lead"}>
                      <strong>{formatToUsd(order?.data?.itemPrice)}</strong>
                    </p>
                  </Col>
                  <Col lg={5}>
                  ...
                  <Col lg={6}>
                    <p className={"lead"}>
                      <strong>{formatToUsd(order?.data?.taxPrice)}</strong>
                    </p>
                  </Col>
                  <Col lg={5}>
                  ...
                  <Col lg={6}>
                    <p className={"lead"}>
                      <strong>{formatToUsd(order?.data?.totalPrice)}</strong>
                    </p>
                  </Col>
                </Row>
              </Col>
