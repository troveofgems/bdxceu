  ...
  return (
    <section id="facility-services" className="parallax-section mb-5">
      <div className="container">
        <div className="row">
          <div className="col-md-6 col-sm-12 facilityServicesMobileView">
            <h2 className={"facility__header facilityServices__mobileHeader"}>
              Facility Services
            </h2>
            <img
              src="images/premises_2.jpeg"
          ...
          <div className="wow fadeInUp col-md-5 col-sm-12" data-wow-delay="1s">
            <div className="overview-detail">
              <h2 className={"facility__header facilityServices__header"}>
                Facility Services
              </h2>
              <p>
                Here at Body Dynamix we use the most advanced technology to help
                out clients reach their maximum potential. Our state-of-the-art
