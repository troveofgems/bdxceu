...
export const AuthenticationModal = ({ modalType }) => {
  ...
  const [openModalButtonClasses, setOpenModalButtonClasses] =
    React.useState(applyButtonStyle());
  const [faceCTAButtonLabel, setFaceCTAButtonLabel] = React.useState(
    applyFaceCTAButtonLabel(),
  );
  ...
  return (
    <div>
      <button onClick={openModal} className={openModalButtonClasses}>
        {faceCTAButtonLabel}
      </button>
      <Modal
        isOpen={modalIsOpen}
      ...
      >
        <div className="modalHeaderContent">
          <button
            className={"modalButtonAuth"}
            onClick={() => changeFormView(actionButton)}
          >
            {actionButton}
          </button>
          <button className={"modalButtonAuth"} onClick={closeModal}>
            Close
          </button>
        </div>
